...
//		json.put("message", exceptionResponseObjectBuilder.getError());
//		json.put("serviceName", exceptionResponseObjectBuilder.getServiceName());
//		json.put("time", formatter.format(date));
//		json.put("httpStatus", customException.getHttpStatus());
//		kafkaTemplate.send("com.kafka.exception", json);
		System.err.println(exceptionResponseObjectBuilder);
...
//	public ResponseEntity<ExceptionResponseObject> notOfficeXmlFileException(
//			NotOfficeXmlFileException aWSSecurityTokenServiceException) {
//		System.out.println("empty file or something is corrupted ");
//		HashMap<String,Object> json = new HashMap<String,Object>();
//		Date date = new Date();
...
//		json.put("serviceName", exceptionResponseObjectBuilder.getServiceName());
//		json.put("time", formatter.format(date));
//		json.put("httpStatus", badRequest);
//		kafkaTemplate.send("com.kafka.exception", json);
//		return new ResponseEntity<ExceptionResponseObject>(exceptionResponseObjectBuilder, badRequest);
//
//	}
//
//	@SuppressWarnings("unchecked")
