...
//	@Value("${bucket_name}")
	...
	public String uploadFile(MultipartFile file) throws IOException {
		...
		PutObjectResult res = awsClient.putObject(bucketName, fileName, file.getInputStream(), obm);

		System.out.println(res + "BUCKET:- " + bucketName + "fileName : : " + file.getOriginalFilename());
